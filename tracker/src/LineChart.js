...
class LineChart extends React.Component {
    render() {
        ...
        const trace = {
            x: ['2021/01/27','2021/02/01','2021/02/05','2021/02/15','2021/02/22','2021/03/06',
            ...
            '2021/09/10','2021/09/19','2022/05/21'],
            y: [100,500,1000,2000,3000,4000,5000,6000,
                7000,8000,9000,10000,11000,12000,13000,
                14000,15000,16000,17000,18000,19000,20000,
                21000,22000,23000,24000,29000],
            mode: "markers+lines",
            type: "scatter",
          };
          const data = [trace];
